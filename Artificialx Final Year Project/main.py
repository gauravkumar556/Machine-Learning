       ...
       for i in words:
              ...
              if(flag==-1):
                     for j in i:
                            print(j,i)
                            try:
                                   im = PIL.Image.open(alpha_dest+str(j).lower()+"_small.png")
...
class StartPage(tk.Frame):
       ...
       def __init__(self, parent, controller):
              ...
              button.pack()
              button2 = tk.Button(self, text="Sign to Text",command=lambda: ap.mainlo())
              button2.pack()
...
class VtoS(tk.Frame):
       def __init__(self, parent, controller):
              ...
              def Take_input():
                     ...
                     temp = translator.translate(INPUT)
                     if(temp==''):
                            temp=INPUT
                     print(temp)
                     global gif_frames
                     gif_frames=func(temp)
                     global cnt
                     cnt=0
                     gif_stream()
