...
def login():
                ...
                def manage_student():
                    try:
                        ...
                        def add_employee():
                            ...
                            if post_var.get() == "" or fname_var.get() == "" or gender_var.get() ==  "" or contact_var.get() == "" or address_var.get() == "" or sid_var.get()=="":
                                        ...
                                        if (re.search('[0-9]$', contact_var.get())):
                                            ...
                                            if(re.search(regex, address_var.get())):
                                                ...
                                                if not os.path.exists(input_directory):
                                                    ...
                                                    cur1 = conn.cursor()
                                                    cur1.execute("insert into attendance(sid,department,fname,gender,contact_no,email) VALUES (%s,%s,%s,%s,%s,%s)", (sid_var.get(),
                                                                                                                                                                                post_var.get(),
                                                                                                                                                                                fname_var.get(),
                                                                                                                                                                                gender_var.get(),
                                                                                                                                                                                contact_var.get(),
                                            ...
                                            if(re.search(regex, address_var.get())):
                                                ...
                                                if id in staff_ids:
                                                    ...
                                                    if (q == True):
                                                        ...
                                                        video_capture.release()
                                                        cv2.destroyAllWindows()
                                                        cur.execute("update attendance set department = %s, fname = %s, gender = %s, contact_no = %s, email = %s where sid = %s", (                                                               
                                                                                                    post_var.get(),
                                                                                                    fname_var.get(),
                                                                                                    gender_var.get(),
                                                                                                    contact_var.get(),
                    ...
                    ################################################## Student Management form ###############################
                        ...
                        id = Label(f2, text = "Registeration Number", bg = "gray", font = ("italic",13, "bold")).place(x = 35, y = 100 )
                        E1 = Entry(f2, width = 20, textvariable = sid_var,  font = ("italic",13, "bold") ).place(x = 180  , y = 100)
                    ...
                    ################################################################################## Table frame
                        ...
                        table1 = Treeview(f5, columns = ("sid","post", "fname","gender","contact.no","address"), xscrollcommand = scroll_x.set, yscrollcommand = scroll_y.set)
    ...
    ######################################### Function to recognize the face
                ...
                def report():
                    ...
                    search_combo = Combobox(text_fill, textvariable = search_by, values = ['date', 'name','id'], state = 'readonly', font = ("times new roman", 15),width = 15)
                    ...
                    report_table.heading('ID', text = "Student ID") 
